...
export const ChallengeOptionForm = ({
  optionId,
  initialData,
  preselectedChallengeId,
}: ChallengeOptionFormProps) => {
      ...
      <form onSubmit={handleSubmit} className='space-y-6'>
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setFormData((prev) => ({
                ...prev,
                challengeId: parseInt(e.target.value),
              }))
            }
          ...
          >
            ...
            {challenges.map((challenge) => (
              <option key={challenge.id} value={challenge.id}>
                ...
                {challenge.lesson.unit.title} → {challenge.lesson.title} →{" "}
        ...
        <div>
          <div className='flex items-center'>
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({ ...prev, correct: e.target.checked }))
              }
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setFormData((prev) => ({ ...prev, guide: e.target.value }))
            }
