...
const AdminChallengeEditPage = async ({ params }: { params: { challengeId: string } }) => {
  if (!(await isAdmin())) {
    return redirect("/")
  }
                    ...
                    >
                      <div className='flex items-start justify-between'>
                        <div className='flex-1 min-w-0'>
                          ...
                          <h4 className='text-sm font-medium text-gray-900 mb-1'>{option.text}</h4>
                          {option.guide && (
              ...
              <Card className='border-red-200 bg-red-50'>
                <CardContent className='pt-6'>
                  <div className='flex'>
                    ...
                    <div className='ml-3'>
                      <h3 className='text-sm font-medium text-red-800'>Missing Correct Answer</h3>
              ...
              <Card className='border-orange-200 bg-orange-50'>
                <CardContent className='pt-6'>
                  <div className='flex'>
                    ...
                    <div className='ml-3'>
                      <h3 className='text-sm font-medium text-orange-800'>Deletion Warning</h3>
                      <p className='mt-1 text-sm text-orange-700'>
                        Deleting this challenge will also delete all {challengeOptions.length}{" "}
                        answer options. This action cannot be undone.
                      </p>
                    </div>
                  </div>
                </CardContent>
