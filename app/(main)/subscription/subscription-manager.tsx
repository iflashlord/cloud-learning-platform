...
import { Crown, Calendar, CreditCard, CheckCircle, XCircle, AlertTriangle, Settings, Star, Shield, Zap, Heart, Target, Award, Sparkles, ArrowRight, ExternalLink, MessageSquare, HelpCircle, Mail } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
          Manage your {BRAND_CONFIG.PLATFORM_NAME} Pro subscription, billing settings, and explore premium features designed to enhance your learning experience.
        </p>
      </div>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        You&apos;ll lose access to Pro features when your current billing period ends on {formatDate(subscription?.stripeCurrentPeriodEnd)}. Your learning progress will remain saved.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {proFeatures.map((feature, index) => (
                  <div key={index} className="flex items-start gap-3 p-4 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800/50">
                    <div className="w-8 h-8 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-lg flex items-center justify-center flex-shrink-0 text-white">
                      {feature.icon}
                    </div>
                    <div>
          ...
          <Card className="bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border-yellow-300 dark:border-yellow-700/50">
            <CardContent className="p-8 text-center">
              <div className="space-y-6">
                <div>
                  <div className="text-4xl font-bold text-yellow-600 dark:text-yellow-400">$9.99</div>
          ...
          <Card className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 border-green-200 dark:border-green-800">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-3 bg-white/60 dark:bg-black/20 rounded-lg">
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{userProgress.points}</div>
              ...
              {isPro && (
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800">
                  ...
                  <p className="text-sm text-yellow-600 dark:text-yellow-400">
                    As a Pro member, you get priority support with faster response times (within 4 hours)
                  </p>
                </div>
              )}
            </div>
