import { BookOpen, User, Target, Play, Award, CheckCircle, ArrowRight, Star, Heart, Zap } from "lucide-react";
  ...
  const steps = [
    {
      ...
      completed: true,
      actions: [
        { label: "Already signed up? Manage Profile", href: "/help/account-settings" }
      ]
    },
    {
      number: 2,
      ...
      <Card className="mb-8 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border-blue-200 dark:border-blue-800">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            You&apos;re about to start an exciting journey learning Amazon Web Services (AWS). 
            Our platform makes cloud learning interactive, engaging, and fun through gamified lessons.
          </p>
        </CardContent>
      </Card>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          {steps.map((step, index) => {
            ...
            return (
              <Card key={index} className={step.completed ? "border-green-200 dark:border-green-800" : ""}>
                  ...
                  <div className="flex items-start gap-4">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 ${
                      ...
                      {step.completed ? (
                        ...
                        <span className="text-blue-600 dark:text-blue-400 font-bold">{step.number}</span>
                      )}
                    </div>
