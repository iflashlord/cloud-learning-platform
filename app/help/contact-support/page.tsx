    ...
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {supportOptions.map((option, index) => {
            ...
            return (
              <Card key={index} className={option.isPro ? "border-yellow-200 dark:border-yellow-800 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20" : ""}>
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <Button asChild className={option.isPro ? "bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600" : ""}>
      ...
      <div className="mt-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Button variant="outline" asChild>
            <Link href="/help/technical-issues">
              Technical Issues
            </Link>
          </Button>
        </div>
