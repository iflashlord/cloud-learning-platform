    ...
    await db.insert(schema.courses).values([
      {
        ...
        category: "AWS",
        description: "Build foundational knowledge of cloud concepts and AWS services. Perfect for beginners entering the cloud computing field.",
        level: "Beginner",
        duration: "2-3 hours",
      },
      {
        ...
        description: "Learn to design distributed systems and applications on AWS. Essential for cloud architects and engineers.",
        level: "Intermediate",
        duration: "4-6 hours",
      },
      {
        ...
        description: "Master AWS services for application development and deployment. Great for developers building cloud applications.",
        level: "Intermediate",
        duration: "3-5 hours",
      },
      {
        ...
        category: "DevOps",
        description: "Develop expertise in deploying, managing, and operating AWS systems. Perfect for system administrators.",
        level: "Advanced",
        duration: "5-7 hours",
      },
    ]);
