...
export const RecentActivity = ({
  ...
  return (
    <Card className='p-6'>
      <div className='flex items-center justify-between mb-6'>
        <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-400'>Recent Activity</h2>
        <Activity className='w-5 h-5 text-gray-400' />
      </div>
      <div className='space-y-4'>
        {activities.map((activity) => {
          ...
          return (
            <div
              key={activity.id}
              className='flex items-start space-x-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-200'
            >
              <div className={`p-2 rounded-lg ${colorClasses}`}>
                <IconComponent className='w-4 h-4' />
              </div>
              <div className='flex-1 min-w-0'>
                <div className='text-sm font-medium text-gray-900 dark:text-gray-400 truncate'>
                  {activity.title}
                </div>
