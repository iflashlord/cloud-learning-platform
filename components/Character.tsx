...
const CHARACTER_VARIANTS: Record<CharacterType, CharacterVariant[]> = {
  SELECT: [
    ...
    { Icon: Brain, name: "Strategist", expression: "Analyzing choices" },
    {
      Icon: Target,
      name: "Sharpshooter",
      expression: "Aiming for the right answer",
    },
  ],
  ASSIST: [
  ...
  DRAG_DROP: [
    {
      Icon: GripVertical,
      name: "Organizer",
      expression: "Sorting everything out",
    },
    {
      Icon: ListChecks,
      name: "Planner",
      expression: "Keeping things in order",
    },
    {
      Icon: ArrowUpDown,
      name: "Navigator",
      expression: "Arranging the sequence",
    },
  ],
  TEXT_INPUT: [
    { Icon: Keyboard, name: "Typist", expression: "Ready to write" },
    {
      Icon: PenLine,
      name: "Author",
      expression: "Crafting the perfect response",
    },
  ...
  IMAGE_SELECT: [
    {
      Icon: ImageIcon,
      name: "Curator",
      expression: "Selecting the best image",
    },
...
export const Character = ({
  ...
  return (
    <div className={`flex flex-col items-center space-y-3 ${className}`}>
      {/* Character Avatar */}
      <div
        className={`relative w-20 h-20 rounded-full bg-gradient-to-br ${getTypeColor(
          questionType
      ...
      <div className='text-center'>
        ...
        <p
          className={`text-xs italic max-w-32 leading-tight transition-colors duration-300 ${expressionColorClass}`}
        >
        ...
        {/* Question Type Badge */}
        <div
          className={`mt-2 px-3 py-1 rounded-full text-xs font-medium text-white bg-gradient-to-r ${getTypeColor(
            questionType
          )}`}
        >
