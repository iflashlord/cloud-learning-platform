...
export const ProBonusSection = ({
  isPro,
  userGems,
  onGemsChange,
}: ProBonusSectionProps) => {
  ...
  const handleClaimBonus = () => {
    startTransition(async () => {
      try {
        ...
        toast.success(`You claimed your daily Pro bonus of ${GAMIFICATION.GEMS_PRO_DAILY_BONUS} gems!`, {
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mt-1">
                <CurrencyDisplay
                  type="gems"
                  value={GAMIFICATION.GEMS_PRO_DAILY_BONUS}
                  size="sm"
                />
