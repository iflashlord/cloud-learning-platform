      ...
      <div className='relative z-10'>
        ...
        <div className='flex items-center gap-3 mb-4'>
          ...
          <div className='flex-1'>
            ...
            <p className='text-purple-100 text-sm'>{formatMonth(quest.month, quest.year)}</p>
          </div>
        </div>

        {/* Description */}
        <p className='text-purple-100 text-sm mb-4'>{quest.description}</p>
        ...
        <div className='mb-4'>
          <div className='flex justify-between items-center mb-2'>
            ...
            <span className='text-sm text-purple-100'>{Math.round(progressPercentage)}%</span>
          </div>
        ...
        {!isCompleted && (
          <div className='flex items-center gap-2 mb-4 text-purple-100'>
            ...
            <span className='text-sm'>{daysRemaining} days remaining this month</span>
          </div>
        )}
