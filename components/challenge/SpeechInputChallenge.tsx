  ...
  return (
    <div className="space-y-4">
      <div className={cn("mt-3 p-3 rounded-lg border", statusStyles.info.bg, statusStyles.info.border)}>
        <p className={cn("text-sm font-medium flex items-center gap-2", statusStyles.info.text)}>
          <Mic className="w-4 h-4" />
          <span>Voice Input Mode - Click the microphone and speak your answer clearly. Use the CHECK button below to submit.</span>
        </p>
      </div>
