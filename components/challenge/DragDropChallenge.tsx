...
export const DragDropChallenge = ({
  ...
  useEffect(() => {
    ;(window as any).checkCurrentDragOrder = () => {
      const isCorrect = draggedItems.every(
    ...
    <div className='space-y-4'>
      ...
      >
        ...
        >
          ...
          <span>
            Arrange items in the correct order. You can drag & drop or use the
            ↑↓ buttons.
          </span>
        </p>
      </div>
              ...
              <div key={item.id} className='relative group'>
                <div
                  ...
                  className={cn(
                    ...
                    !disabled &&
                      "cursor-move hover:border-primary-300 hover:shadow-md hover:scale-[1.02]",
        ...
        <div className='mt-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg'>
          <div className='flex items-center justify-between text-sm'>
            <span className='text-gray-600 dark:text-gray-400'>
              Progress:{" "}
              {
                draggedItems.filter((item, index) => item.order === index + 1)
                  .length
              }{" "}
              / {draggedItems.length} correct
            </span>
