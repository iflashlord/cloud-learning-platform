/**
 * Database Queries - Main Export (Modularized)
 * 
 * This file has been modularized into focused database query modules:
 * 
 * @example
 * ```typescript
 * // Import specific queries (recommended)
 ...
 * 
 * Modules:
 * - user-queries.ts: User progress, subscriptions, and leaderboard queries
 * - course-queries.ts: Course data with progress calculations and admin queries
 * - lesson-queries.ts: Lesson data with completion tracking
 * - unit-queries.ts: Unit data with lesson completion status
 */

// Re-export everything from the modular queries library
